...
* [Airflow](https://github.com/airbnb/airflow) ⭐ 46,632 | 🐛 1,981 | 🌐 Python | 📅 2026-08-28 - Python-based workflow system created by AirBnb.
* [Ray](https://github.com/ray-project/ray) ⭐ 43,639 | 🐛 3,536 | 🌐 Python | 📅 2026-08-28 - Flexible, high-performance distributed Python execution framework.
* [Kestra](https://github.com/kestra-io/kestra) ⭐ 27,944 | 🐛 676 | 🌐 Java | 📅 2026-08-28 - Open source data orchestration and scheduling platform with declarative syntax.
...
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 16,072 | 🐛 2,585 | 🌐 Python | 📅 2026-08-28 - Python-based API for defining DAGs that interfaces with popular workflow managers for building data applications.
* [Dask](https://github.com/dask/dask) ⭐ 13,901 | 🐛 1,317 | 🌐 Python | 📅 2026-08-24 - Dask is a flexible parallel computing library for analytics.
* [Cocoindex](https://github.com/cocoindex-io/cocoindex) ⭐ 11,428 | 🐛 74 | 🌐 Rust | 📅 2026-08-28 - ETL framework to build fresh index.
* [Kedro](https://github.com/quantumblacklabs/kedro) ⭐ 10,975 | 🐛 143 | 🌐 Python | 📅 2026-08-28 - Workflow development tool that helps you build data pipelines.
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,582 | 🐛 156 | 🌐 Jupyter Notebook | 📅 2026-08-19 - A python micro-framework for describing dataflows; runs anywhere python runs.
* [Burr](https://github.com/dagworks-inc/burr) ⭐ 2,531 | 🐛 108 | 🌐 Python | 📅 2026-08-25 - Python based lightweight graph (i.e. can do loops and conditional branching, and not just DAGs) orchestrator.
...
* [Drake R package](https://github.com/ropensci/drake) ⭐ 1,342 | 🐛 0 | 🌐 R | 📅 2024-12-04 - Reproducibility and high-performance computing with an easy R-focused interface. Unrelated to [Factual's Drake](https://github.com/factual/drake) ⭐ 1,485 | 🐛 83 | 🌐 Clojure | 📅 2022-04-12. Succeeded by [Targets](https://github.com/ropensci/targets) ⭐ 1,095 | 🐛 0 | 🌐 R | 📅 2026-05-13.
* [Targets](https://github.com/ropensci/targets) ⭐ 1,095 | 🐛 0 | 🌐 R | 📅 2026-05-13 - Dynamic, function-oriented [Make](https://www.gnu.org/software/make/)-like reproducible pipelines at scale in R.
...
* [Toil](https://github.com/BD2KGenomics/toil) ⭐ 936 | 🐛 405 | 🌐 Python | 📅 2026-08-28 - Distributed pipeline workflow manager (mostly for genomics).
...
* [Redun](https://github.com/insitro/redun) ⭐ 598 | 🐛 34 | 🌐 Python | 📅 2026-07-17 - Yet another redundant workflow engine.
* [AiiDA](https://github.com/aiidateam/aiida-core) ⭐ 579 | 🐛 674 | 🌐 Python | 📅 2026-08-27 - workflow manager with a strong focus on provenance, performance and extensibility.
* [HyperQueue](https://github.com/It4innovations/hyperqueue) ⭐ 554 | 🐛 56 | 🌐 Rust | 📅 2026-08-28 - HPC-focused task scheduler that automatically assigns tasks to Slurm/PBS allocations and submits them for the user.
* [PipeFunc](https://github.com/pipefunc/pipefunc) ⭐ 477 | 🐛 75 | 🌐 Python | 📅 2026-08-28 - Lightweight function pipeline (DAG) creation in pure Python for scientific workflows.
...
* [Mistral](https://github.com/openstack/mistral) ⭐ 309 | 🐛 0 | 🌐 Python | 📅 2026-08-27 - Python based workflow engine by the Open Stack project.
...
* [nFlow](https://github.com/NitorCreations/nFlow) ⭐ 238 | 🐛 25 | 🌐 Java | 📅 2026-08-28 - Embeddable JVM-based workflow engine with high availability, fault tolerance, and support for multiple databases. Additional libraries are provided for visualization and REST API.
...
* [Maestro](https://github.com/LLNL/maestrowf) ⭐ 162 | 🐛 91 | 🌐 Python | 📅 2026-08-13 - YAML based HPC workflow execution tool.
* [PyFlow](https://github.com/Illumina/pyflow) ⭐ 148 | 🐛 14 | 🌐 Python | 📅 2020-07-01 - Lightweight parallel task engine.
* [pytask](https://github.com/pytask-dev/pytask) ⭐ 146 | 🐛 19 | 🌐 Python | 📅 2026-08-28 - A workflow management system that facilitates reproducible data analyses.
...
* [Windmill](https://github.com/windmill-labs/windmill) ⭐ 17,711 | 🐛 832 | 🌐 Rust | 📅 2026-08-28 - Developer platform and workflow engine to turn scripts into internal tools.
* [Flyte](https://github.com/lyft/flyte) ⭐ 7,304 | 🐛 167 | 🌐 Go | 📅 2026-08-28 - Container-native, type-safe workflow and pipelines platform for large scale processing and ML.
* [Orchest](https://github.com/orchest/orchest) ⚠️ Archived - An IDE for Data Science.
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,726 | 🐛 126 | 🌐 MDX | 📅 2026-08-28 - A platform for machine learning experimentation workflow.
...
* [Fireworks](https://github.com/materialsproject/fireworks) ⭐ 425 | 🐛 74 | 🌐 Python | 📅 2026-08-28 - Centralized workflow server for dynamic workflows of high-throughput computations.
...
* [Reana](https://github.com/reanahub/reana) ⭐ 152 | 🐛 103 | 🌐 Python | 📅 2026-08-20 - Platform for reusable research data analyses developed by CERN.
* [omega|ml DataOps Platform](https://github.com/omegaml/omegaml) ⭐ 107 | 🐛 99 | 🌐 Python | 📅 2026-08-28 - Data & model pipeline deployment for humans - integrated, scalable, extensible.
...
* [Sushi](https://github.com/uzh/sushi) ⭐ 29 | 🐛 0 | 🌐 Ruby | 📅 2026-08-28 - Supporting User for SHell script Integration.
...
* [Workflow Description Language](https://github.com/openwdl/wdl) ⭐ 856 | 🐛 69 | 📅 2026-08-28
...
* [lakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,499 | 🐛 439 | 🌐 Go | 📅 2026-08-19 - Repeatable, atomic and versioned data lake on top of object storage.
* [Nessie](https://github.com/projectnessie/nessie) ⭐ 1,497 | 🐛 165 | 🌐 Java | 📅 2026-08-28 - Provides Git-like capability & version control for Iceberg Tables, Delta Lake Tables & SQL Views.
...
* [Cadence](https://github.com/uber/cadence) ⭐ 9,423 | 🐛 200 | 🌐 Go | 📅 2026-08-28 Distributed, scalable, durable, and highly available orchestration engine developed by Uber.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,678 | 🐛 60 | 🌐 Go | 📅 2026-08-28 - Data pipeline framework supporting SQL and Python in the same DAG. Built-in data quality assertions, cross-database lineage, and incremental processing. Targets data warehouses (BigQuery, Snowflake, Postgres, etc.).
...
* [Argo](https://github.com/argoproj/argo) ⭐ 16,945 | 🐛 1,254 | 🌐 Go | 📅 2026-08-28 - Get stuff done with container-native workflows for Kubernetes.
* [CDS](https://github.com/ovh/cds) ⭐ 4,837 | 🐛 159 | 🌐 Go | 📅 2026-08-28 - A pipeline based Continuous Delivery Service written in Golang.

## Build automation tools

* [Just](https://github.com/casey/just) ⭐ 35,531 | 🐛 171 | 🌐 Rust | 📅 2026-08-20 - Command and recipe runner similar to Make, built in Rust.
* [doit](https://github.com/pydoit/doit) ⭐ 2,084 | 🐛 94 | 🌐 Python | 📅 2026-02-12 - Highly generalized task-management and automation in Python.
...
* [noWorkflow](https://github.com/gems-uff/noworkflow) ⭐ 127 | 🐛 51 | 🌐 Jupyter Notebook | 📅 2026-08-13 - Supporting infrastructure to run scientific experiments without a scientific workflow management system, and still get things like provenance.
...
* [Awesome workflow engines](https://github.com/meirwah/awesome-workflow-engines) ⭐ 7,916 | 🐛 71 | 📅 2026-04-06 - Curated list of awesome open source workflow engines.
...
* [Awesome streaming](https://github.com/manuzhang/awesome-streaming) ⭐ 3,009 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-28 - Curated list of awesome streaming frameworks, applications.
