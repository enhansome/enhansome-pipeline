...
A curated list of awesome pipeline toolkits inspired by [Awesome Sysadmin](https://github.com/kahun/awesome-sysadmin) ⭐ 24,348 | 🐛 270 | 📅 2024-03-26

## Pipeline frameworks & libraries

* [Airflow](https://github.com/airbnb/airflow) ⭐ 46,522 | 🐛 1,887 | 🌐 Python | 📅 2026-08-18 - Python-based workflow system created by AirBnb.
* [Ray](https://github.com/ray-project/ray) ⭐ 43,544 | 🐛 3,508 | 🌐 Python | 📅 2026-08-18 - Flexible, high-performance distributed Python execution framework.
* [Kestra](https://github.com/kestra-io/kestra) ⭐ 27,851 | 🐛 543 | 🌐 Java | 📅 2026-08-18 - Open source data orchestration and scheduling platform with declarative syntax.
...
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 16,016 | 🐛 2,592 | 🌐 Python | 📅 2026-08-14 - Python-based API for defining DAGs that interfaces with popular workflow managers for building data applications.
* [Dask](https://github.com/dask/dask) ⭐ 13,890 | 🐛 1,308 | 🌐 Python | 📅 2026-08-17 - Dask is a flexible parallel computing library for analytics.
* [Cocoindex](https://github.com/cocoindex-io/cocoindex) ⭐ 11,344 | 🐛 73 | 🌐 Rust | 📅 2026-08-17 - ETL framework to build fresh index.
* [Kedro](https://github.com/quantumblacklabs/kedro) ⭐ 10,954 | 🐛 151 | 🌐 Python | 📅 2026-08-18 - Workflow development tool that helps you build data pipelines.
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,568 | 🐛 152 | 🌐 Jupyter Notebook | 📅 2026-08-17 - A python micro-framework for describing dataflows; runs anywhere python runs.
* [Burr](https://github.com/dagworks-inc/burr) ⭐ 2,517 | 🐛 102 | 🌐 Python | 📅 2026-08-17 - Python based lightweight graph (i.e. can do loops and conditional branching, and not just DAGs) orchestrator.
...
* [Toil](https://github.com/BD2KGenomics/toil) ⭐ 936 | 🐛 412 | 🌐 Python | 📅 2026-08-18 - Distributed pipeline workflow manager (mostly for genomics).
...
* [Covalent](https://github.com/AgnostiqHQ/covalent) ⭐ 867 | 🐛 100 | 🌐 Python | 📅 2026-08-17 - Workflow orchestration toolkit for high-performance and quantum computing research and development.
* [NiPype](https://github.com/nipy/nipype) ⭐ 834 | 🐛 433 | 🌐 Python | 📅 2026-07-20 - Workflows and interfaces for neuroimaging packages.
* [Koheesio](https://github.com/Nike-Inc/koheesio) ⭐ 818 | 🐛 33 | 🌐 Python | 📅 2026-08-01 - Python framework for building efficient data pipelines.
...
* [AiiDA](https://github.com/aiidateam/aiida-core) ⭐ 577 | 🐛 669 | 🌐 Python | 📅 2026-08-17 - workflow manager with a strong focus on provenance, performance and extensibility.
* [HyperQueue](https://github.com/It4innovations/hyperqueue) ⭐ 552 | 🐛 56 | 🌐 Rust | 📅 2026-08-17 - HPC-focused task scheduler that automatically assigns tasks to Slurm/PBS allocations and submits them for the user.
* [PipeFunc](https://github.com/pipefunc/pipefunc) ⭐ 477 | 🐛 75 | 🌐 Python | 📅 2026-08-17 - Lightweight function pipeline (DAG) creation in pure Python for scientific workflows.
...
* [Mistral](https://github.com/openstack/mistral) ⭐ 308 | 🐛 0 | 🌐 Python | 📅 2026-08-14 - Python based workflow engine by the Open Stack project.
...
* [pytask](https://github.com/pytask-dev/pytask) ⭐ 146 | 🐛 15 | 🌐 Python | 📅 2026-08-17 - A workflow management system that facilitates reproducible data analyses.
* [Pydra](https://github.com/nipype/pydra) ⭐ 143 | 🐛 102 | 🌐 Python | 📅 2026-08-18 - Lightweight, DAG-based Python dataflow engine for reproducible and scalable scientific pipelines.
...
* [Velda](https://github.com/velda-io/velda) ⭐ 82 | 🐛 2 | 🌐 Go | 📅 2026-08-11 - Workflow compute layer that lets any job start instantly, scale across clouds, and avoid dependency drift by design.
...
* [StreamFlow](https://github.com/alpha-unito/streamflow) ⭐ 65 | 🐛 33 | 🌐 Python | 📅 2026-08-18 - Container native workflow management system focused on hybrid workflows.
...
* [Windmill](https://github.com/windmill-labs/windmill) ⭐ 17,571 | 🐛 814 | 🌐 Rust | 📅 2026-08-18 - Developer platform and workflow engine to turn scripts into internal tools.
* [Flyte](https://github.com/lyft/flyte) ⭐ 7,208 | 🐛 166 | 🌐 Go | 📅 2026-08-18 - Container-native, type-safe workflow and pipelines platform for large scale processing and ML.
* [Orchest](https://github.com/orchest/orchest) ⚠️ Archived - An IDE for Data Science.
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,719 | 🐛 126 | 🌐 MDX | 📅 2026-08-17 - A platform for machine learning experimentation workflow.
...
* [omega|ml DataOps Platform](https://github.com/omegaml/omegaml) ⭐ 107 | 🐛 98 | 🌐 Python | 📅 2026-08-18 - Data & model pipeline deployment for humans - integrated, scalable, extensible.
...
* [Sushi](https://github.com/uzh/sushi) ⭐ 29 | 🐛 0 | 🌐 Ruby | 📅 2026-08-18 - Supporting User for SHell script Integration.
...
* [lakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,490 | 🐛 439 | 🌐 Go | 📅 2026-08-17 - Repeatable, atomic and versioned data lake on top of object storage.
* [Nessie](https://github.com/projectnessie/nessie) ⭐ 1,494 | 🐛 163 | 🌐 Java | 📅 2026-08-18 - Provides Git-like capability & version control for Iceberg Tables, Delta Lake Tables & SQL Views.
...
* [Pathway](https://github.com/pathwaycom/pathway/) ⭐ 62,430 | 🐛 35 | 🌐 Python | 📅 2026-08-18 - Performant open-source Python ETL framework with Rust runtime, supporting 300+ data sources.
* [Cadence](https://github.com/uber/cadence) ⭐ 9,404 | 🐛 188 | 🌐 Go | 📅 2026-08-18 Distributed, scalable, durable, and highly available orchestration engine developed by Uber.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,669 | 🐛 31 | 🌐 Go | 📅 2026-08-18 - Data pipeline framework supporting SQL and Python in the same DAG. Built-in data quality assertions, cross-database lineage, and incremental processing. Targets data warehouses (BigQuery, Snowflake, Postgres, etc.).
* [Dataform](https://github.com/dataform-co/dataform) ⭐ 994 | 🐛 116 | 🌐 TypeScript | 📅 2026-08-18 - Dataform is a framework for managing SQL based operations in your data warehouse.
...
* [Argo](https://github.com/argoproj/argo) ⭐ 16,910 | 🐛 1,258 | 🌐 Go | 📅 2026-08-18 - Get stuff done with container-native workflows for Kubernetes.
* [CDS](https://github.com/ovh/cds) ⭐ 4,833 | 🐛 158 | 🌐 Go | 📅 2026-08-18 - A pipeline based Continuous Delivery Service written in Golang.

## Build automation tools

* [Just](https://github.com/casey/just) ⭐ 35,347 | 🐛 170 | 🌐 Rust | 📅 2026-08-12 - Command and recipe runner similar to Make, built in Rust.
...
* [Awesome ETL](https://github.com/pawl/awesome-etl) ⭐ 3,583 | 🐛 11 | 📅 2026-05-01 - Curated list of notable ETL (extract, transform, load) frameworks, libraries and software.
* [Awesome streaming](https://github.com/manuzhang/awesome-streaming) ⭐ 3,004 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-17 - Curated list of awesome streaming frameworks, applications.
