...
* [Airflow](https://github.com/airbnb/airflow) ⭐ 46,615 | 🐛 1,963 | 🌐 Python | 📅 2026-08-27 - Python-based workflow system created by AirBnb.
* [Ray](https://github.com/ray-project/ray) ⭐ 43,617 | 🐛 3,539 | 🌐 Python | 📅 2026-08-27 - Flexible, high-performance distributed Python execution framework.
* [Kestra](https://github.com/kestra-io/kestra) ⭐ 27,934 | 🐛 685 | 🌐 Java | 📅 2026-08-27 - Open source data orchestration and scheduling platform with declarative syntax.
...
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 16,068 | 🐛 2,588 | 🌐 Python | 📅 2026-08-26 - Python-based API for defining DAGs that interfaces with popular workflow managers for building data applications.
* [Dask](https://github.com/dask/dask) ⭐ 13,897 | 🐛 1,313 | 🌐 Python | 📅 2026-08-24 - Dask is a flexible parallel computing library for analytics.
* [Cocoindex](https://github.com/cocoindex-io/cocoindex) ⭐ 11,413 | 🐛 74 | 🌐 Rust | 📅 2026-08-27 - ETL framework to build fresh index.
* [Kedro](https://github.com/quantumblacklabs/kedro) ⭐ 10,972 | 🐛 143 | 🌐 Python | 📅 2026-08-27 - Workflow development tool that helps you build data pipelines.
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,576 | 🐛 155 | 🌐 Jupyter Notebook | 📅 2026-08-19 - A python micro-framework for describing dataflows; runs anywhere python runs.
...
* [Spiff](https://github.com/knipknap/SpiffWorkflow) ⭐ 1,913 | 🐛 8 | 🌐 Python | 📅 2026-08-10 - Based on the Workflow Patterns initiative and implemented in Python.
...
* [Toil](https://github.com/BD2KGenomics/toil) ⭐ 936 | 🐛 404 | 🌐 Python | 📅 2026-08-26 - Distributed pipeline workflow manager (mostly for genomics).
...
* [AiiDA](https://github.com/aiidateam/aiida-core) ⭐ 579 | 🐛 671 | 🌐 Python | 📅 2026-08-27 - workflow manager with a strong focus on provenance, performance and extensibility.
* [HyperQueue](https://github.com/It4innovations/hyperqueue) ⭐ 553 | 🐛 56 | 🌐 Rust | 📅 2026-08-27 - HPC-focused task scheduler that automatically assigns tasks to Slurm/PBS allocations and submits them for the user.
* [PipeFunc](https://github.com/pipefunc/pipefunc) ⭐ 477 | 🐛 75 | 🌐 Python | 📅 2026-08-27 - Lightweight function pipeline (DAG) creation in pure Python for scientific workflows.
...
* [nFlow](https://github.com/NitorCreations/nFlow) ⭐ 238 | 🐛 24 | 🌐 Java | 📅 2026-08-26 - Embeddable JVM-based workflow engine with high availability, fault tolerance, and support for multiple databases. Additional libraries are provided for visualization and REST API.
...
* [ecFlow](https://github.com/ecmwf/ecflow) ⭐ 64 | 🐛 17 | 🌐 C++ | 📅 2026-08-27 - Workflow manager.
...
* [Windmill](https://github.com/windmill-labs/windmill) ⭐ 17,694 | 🐛 835 | 🌐 Rust | 📅 2026-08-27 - Developer platform and workflow engine to turn scripts into internal tools.
* [Flyte](https://github.com/lyft/flyte) ⭐ 7,249 | 🐛 164 | 🌐 Go | 📅 2026-08-27 - Container-native, type-safe workflow and pipelines platform for large scale processing and ML.
* [Orchest](https://github.com/orchest/orchest) ⚠️ Archived - An IDE for Data Science.
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,724 | 🐛 126 | 🌐 MDX | 📅 2026-08-26 - A platform for machine learning experimentation workflow.
...
* [Reana](https://github.com/reanahub/reana) ⭐ 152 | 🐛 102 | 🌐 Python | 📅 2026-08-20 - Platform for reusable research data analyses developed by CERN.
...
* [Geoweaver](https://github.com/ESIPFed/Geoweaver) ⭐ 95 | 🐛 44 | 🌐 JavaScript | 📅 2026-08-27 - In-browser tool for data processing workflows with high-performance server support, featuring code history and workflow orchestration.
...
* [Workflow Description Language](https://github.com/openwdl/wdl) ⭐ 856 | 🐛 67 | 📅 2026-08-26
...
* [lakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,496 | 🐛 439 | 🌐 Go | 📅 2026-08-19 - Repeatable, atomic and versioned data lake on top of object storage.
* [Nessie](https://github.com/projectnessie/nessie) ⭐ 1,497 | 🐛 165 | 🌐 Java | 📅 2026-08-27 - Provides Git-like capability & version control for Iceberg Tables, Delta Lake Tables & SQL Views.
...
* [Cadence](https://github.com/uber/cadence) ⭐ 9,420 | 🐛 200 | 🌐 Go | 📅 2026-08-27 Distributed, scalable, durable, and highly available orchestration engine developed by Uber.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,678 | 🐛 34 | 🌐 Go | 📅 2026-08-27 - Data pipeline framework supporting SQL and Python in the same DAG. Built-in data quality assertions, cross-database lineage, and incremental processing. Targets data warehouses (BigQuery, Snowflake, Postgres, etc.).
* [Dataform](https://github.com/dataform-co/dataform) ⭐ 995 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-27 - Dataform is a framework for managing SQL based operations in your data warehouse.
...
* [Argo](https://github.com/argoproj/argo) ⭐ 16,940 | 🐛 1,258 | 🌐 Go | 📅 2026-08-27 - Get stuff done with container-native workflows for Kubernetes.
* [CDS](https://github.com/ovh/cds) ⭐ 4,837 | 🐛 160 | 🌐 Go | 📅 2026-08-26 - A pipeline based Continuous Delivery Service written in Golang.

## Build automation tools

* [Just](https://github.com/casey/just) ⭐ 35,508 | 🐛 171 | 🌐 Rust | 📅 2026-08-20 - Command and recipe runner similar to Make, built in Rust.
* [doit](https://github.com/pydoit/doit) ⭐ 2,083 | 🐛 94 | 🌐 Python | 📅 2026-02-12 - Highly generalized task-management and automation in Python.
...
* [Awesome workflow engines](https://github.com/meirwah/awesome-workflow-engines) ⭐ 7,915 | 🐛 71 | 📅 2026-04-06 - Curated list of awesome open source workflow engines.
...
* [Awesome streaming](https://github.com/manuzhang/awesome-streaming) ⭐ 3,009 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-26 - Curated list of awesome streaming frameworks, applications.
