...
* [Airflow](https://github.com/airbnb/airflow) ⭐ 46,609 | 🐛 1,944 | 🌐 Python | 📅 2026-08-26 - Python-based workflow system created by AirBnb.
* [Ray](https://github.com/ray-project/ray) ⭐ 43,611 | 🐛 3,536 | 🌐 Python | 📅 2026-08-26 - Flexible, high-performance distributed Python execution framework.
* [Kestra](https://github.com/kestra-io/kestra) ⭐ 27,926 | 🐛 703 | 🌐 Java | 📅 2026-08-26 - Open source data orchestration and scheduling platform with declarative syntax.
...
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 16,065 | 🐛 2,587 | 🌐 Python | 📅 2026-08-26 - Python-based API for defining DAGs that interfaces with popular workflow managers for building data applications.
* [Dask](https://github.com/dask/dask) ⭐ 13,896 | 🐛 1,312 | 🌐 Python | 📅 2026-08-24 - Dask is a flexible parallel computing library for analytics.
* [Cocoindex](https://github.com/cocoindex-io/cocoindex) ⭐ 11,407 | 🐛 75 | 🌐 Rust | 📅 2026-08-24 - ETL framework to build fresh index.
* [Kedro](https://github.com/quantumblacklabs/kedro) ⭐ 10,970 | 🐛 140 | 🌐 Python | 📅 2026-08-26 - Workflow development tool that helps you build data pipelines.
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,575 | 🐛 155 | 🌐 Jupyter Notebook | 📅 2026-08-19 - A python micro-framework for describing dataflows; runs anywhere python runs.
* [Burr](https://github.com/dagworks-inc/burr) ⭐ 2,528 | 🐛 108 | 🌐 Python | 📅 2026-08-25 - Python based lightweight graph (i.e. can do loops and conditional branching, and not just DAGs) orchestrator.
...
* [Drake R package](https://github.com/ropensci/drake) ⭐ 1,342 | 🐛 0 | 🌐 R | 📅 2024-12-04 - Reproducibility and high-performance computing with an easy R-focused interface. Unrelated to [Factual's Drake](https://github.com/factual/drake) ⭐ 1,485 | 🐛 83 | 🌐 Clojure | 📅 2022-04-12. Succeeded by [Targets](https://github.com/ropensci/targets) ⭐ 1,094 | 🐛 0 | 🌐 R | 📅 2026-05-13.
* [Targets](https://github.com/ropensci/targets) ⭐ 1,094 | 🐛 0 | 🌐 R | 📅 2026-05-13 - Dynamic, function-oriented [Make](https://www.gnu.org/software/make/)-like reproducible pipelines at scale in R.
...
* [Toil](https://github.com/BD2KGenomics/toil) ⭐ 936 | 🐛 408 | 🌐 Python | 📅 2026-08-25 - Distributed pipeline workflow manager (mostly for genomics).
* [Hera](https://github.com/argoproj-labs/hera) ⭐ 933 | 🐛 26 | 🌐 Python | 📅 2026-08-18 - Hera is an Argo Python SDK. Hera aims to make construction and submission of various Argo Project resources easy and accessible to everyone! Hera abstracts away low-level setup details while still maintaining a consistent vocabulary with Argo.
* [Covalent](https://github.com/AgnostiqHQ/covalent) ⭐ 869 | 🐛 103 | 🌐 Python | 📅 2026-08-17 - Workflow orchestration toolkit for high-performance and quantum computing research and development.
...
* [AiiDA](https://github.com/aiidateam/aiida-core) ⭐ 579 | 🐛 670 | 🌐 Python | 📅 2026-08-26 - workflow manager with a strong focus on provenance, performance and extensibility.
* [HyperQueue](https://github.com/It4innovations/hyperqueue) ⭐ 553 | 🐛 56 | 🌐 Rust | 📅 2026-08-25 - HPC-focused task scheduler that automatically assigns tasks to Slurm/PBS allocations and submits them for the user.
* [PipeFunc](https://github.com/pipefunc/pipefunc) ⭐ 477 | 🐛 75 | 🌐 Python | 📅 2026-08-25 - Lightweight function pipeline (DAG) creation in pure Python for scientific workflows.
...
* [Mistral](https://github.com/openstack/mistral) ⭐ 309 | 🐛 0 | 🌐 Python | 📅 2026-08-26 - Python based workflow engine by the Open Stack project.
...
* [nFlow](https://github.com/NitorCreations/nFlow) ⭐ 237 | 🐛 25 | 🌐 Java | 📅 2026-08-26 - Embeddable JVM-based workflow engine with high availability, fault tolerance, and support for multiple databases. Additional libraries are provided for visualization and REST API.
...
* [pytask](https://github.com/pytask-dev/pytask) ⭐ 146 | 🐛 21 | 🌐 Python | 📅 2026-08-25 - A workflow management system that facilitates reproducible data analyses.
...
* [ecFlow](https://github.com/ecmwf/ecflow) ⭐ 64 | 🐛 17 | 🌐 C++ | 📅 2026-08-26 - Workflow manager.
...
* [Windmill](https://github.com/windmill-labs/windmill) ⭐ 17,686 | 🐛 834 | 🌐 Rust | 📅 2026-08-26 - Developer platform and workflow engine to turn scripts into internal tools.
* [Flyte](https://github.com/lyft/flyte) ⭐ 7,245 | 🐛 167 | 🌐 Go | 📅 2026-08-26 - Container-native, type-safe workflow and pipelines platform for large scale processing and ML.
* [Orchest](https://github.com/orchest/orchest) ⚠️ Archived - An IDE for Data Science.
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,723 | 🐛 126 | 🌐 MDX | 📅 2026-08-26 - A platform for machine learning experimentation workflow.
...
* [Reana](https://github.com/reanahub/reana) ⭐ 152 | 🐛 99 | 🌐 Python | 📅 2026-08-20 - Platform for reusable research data analyses developed by CERN.
* [omega|ml DataOps Platform](https://github.com/omegaml/omegaml) ⭐ 107 | 🐛 99 | 🌐 Python | 📅 2026-08-26 - Data & model pipeline deployment for humans - integrated, scalable, extensible.
* [Geoweaver](https://github.com/ESIPFed/Geoweaver) ⭐ 95 | 🐛 43 | 🌐 JavaScript | 📅 2026-08-26 - In-browser tool for data processing workflows with high-performance server support, featuring code history and workflow orchestration.
...
* [lakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,495 | 🐛 439 | 🌐 Go | 📅 2026-08-19 - Repeatable, atomic and versioned data lake on top of object storage.
* [Nessie](https://github.com/projectnessie/nessie) ⭐ 1,497 | 🐛 164 | 🌐 Java | 📅 2026-08-26 - Provides Git-like capability & version control for Iceberg Tables, Delta Lake Tables & SQL Views.
...
* [Pathway](https://github.com/pathwaycom/pathway/) ⭐ 62,382 | 🐛 36 | 🌐 Python | 📅 2026-08-26 - Performant open-source Python ETL framework with Rust runtime, supporting 300+ data sources.
* [Cadence](https://github.com/uber/cadence) ⭐ 9,414 | 🐛 194 | 🌐 Go | 📅 2026-08-26 Distributed, scalable, durable, and highly available orchestration engine developed by Uber.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,678 | 🐛 33 | 🌐 Go | 📅 2026-08-26 - Data pipeline framework supporting SQL and Python in the same DAG. Built-in data quality assertions, cross-database lineage, and incremental processing. Targets data warehouses (BigQuery, Snowflake, Postgres, etc.).
* [Dataform](https://github.com/dataform-co/dataform) ⭐ 995 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-26 - Dataform is a framework for managing SQL based operations in your data warehouse.
...
* [CDS](https://github.com/ovh/cds) ⭐ 4,837 | 🐛 160 | 🌐 Go | 📅 2026-08-26 - A pipeline based Continuous Delivery Service written in Golang.

## Build automation tools

* [Just](https://github.com/casey/just) ⭐ 35,493 | 🐛 171 | 🌐 Rust | 📅 2026-08-20 - Command and recipe runner similar to Make, built in Rust.
* [doit](https://github.com/pydoit/doit) ⭐ 2,082 | 🐛 94 | 🌐 Python | 📅 2026-02-12 - Highly generalized task-management and automation in Python.
...
* [Awesome streaming](https://github.com/manuzhang/awesome-streaming) ⭐ 3,008 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-25 - Curated list of awesome streaming frameworks, applications.
