...
A curated list of awesome pipeline toolkits inspired by [Awesome Sysadmin](https://github.com/kahun/awesome-sysadmin) ⭐ 24,343 | 🐛 272 | 📅 2024-03-26

## Pipeline frameworks & libraries

* [Airflow](https://github.com/airbnb/airflow) ⭐ 46,791 | 🐛 2,127 | 🌐 Python | 📅 2026-09-09 - Python-based workflow system created by AirBnb.
* [Ray](https://github.com/ray-project/ray) ⭐ 43,759 | 🐛 3,570 | 🌐 Python | 📅 2026-09-09 - Flexible, high-performance distributed Python execution framework.
* [Kestra](https://github.com/kestra-io/kestra) ⭐ 28,057 | 🐛 669 | 🌐 Java | 📅 2026-09-09 - Open source data orchestration and scheduling platform with declarative syntax.
...
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 16,132 | 🐛 2,595 | 🌐 Python | 📅 2026-09-09 - Python-based API for defining DAGs that interfaces with popular workflow managers for building data applications.
* [Dask](https://github.com/dask/dask) ⭐ 13,912 | 🐛 1,329 | 🌐 Python | 📅 2026-08-24 - Dask is a flexible parallel computing library for analytics.
* [Cocoindex](https://github.com/cocoindex-io/cocoindex) ⭐ 11,516 | 🐛 78 | 🌐 Rust | 📅 2026-09-09 - ETL framework to build fresh index.
* [Kedro](https://github.com/quantumblacklabs/kedro) ⭐ 10,990 | 🐛 138 | 🌐 Python | 📅 2026-09-09 - Workflow development tool that helps you build data pipelines.
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,587 | 🐛 168 | 🌐 Jupyter Notebook | 📅 2026-09-08 - A python micro-framework for describing dataflows; runs anywhere python runs.
* [Burr](https://github.com/dagworks-inc/burr) ⭐ 2,540 | 🐛 107 | 🌐 Python | 📅 2026-09-07 - Python based lightweight graph (i.e. can do loops and conditional branching, and not just DAGs) orchestrator.
...
* [Drake](https://github.com/Factual/drake) ⭐ 1,484 | 🐛 83 | 🌐 Clojure | 📅 2022-04-12 - Robust DSL akin to Make, implemented in Clojure.
* [Drake R package](https://github.com/ropensci/drake) ⭐ 1,342 | 🐛 0 | 🌐 R | 📅 2024-12-04 - Reproducibility and high-performance computing with an easy R-focused interface. Unrelated to [Factual's Drake](https://github.com/factual/drake) ⭐ 1,484 | 🐛 83 | 🌐 Clojure | 📅 2022-04-12. Succeeded by [Targets](https://github.com/ropensci/targets) ⭐ 1,096 | 🐛 0 | 🌐 R | 📅 2026-05-13.
* [Targets](https://github.com/ropensci/targets) ⭐ 1,096 | 🐛 0 | 🌐 R | 📅 2026-05-13 - Dynamic, function-oriented [Make](https://www.gnu.org/software/make/)-like reproducible pipelines at scale in R.
* [Cromwell](https://github.com/broadinstitute/cromwell) ⭐ 1,081 | 🐛 815 | 🌐 Scala | 📅 2026-09-03 - Workflow Management System geared towards scientific workflows from the Broad Institute.
...
* [Hera](https://github.com/argoproj-labs/hera) ⭐ 938 | 🐛 29 | 🌐 Python | 📅 2026-09-08 - Hera is an Argo Python SDK. Hera aims to make construction and submission of various Argo Project resources easy and accessible to everyone! Hera abstracts away low-level setup details while still maintaining a consistent vocabulary with Argo.
* [Toil](https://github.com/BD2KGenomics/toil) ⭐ 936 | 🐛 407 | 🌐 Python | 📅 2026-09-03 - Distributed pipeline workflow manager (mostly for genomics).
...
* [NiPype](https://github.com/nipy/nipype) ⭐ 835 | 🐛 426 | 🌐 Python | 📅 2026-09-03 - Workflows and interfaces for neuroimaging packages.
...
* [Redun](https://github.com/insitro/redun) ⭐ 600 | 🐛 34 | 🌐 Python | 📅 2026-07-17 - Yet another redundant workflow engine.
* [AiiDA](https://github.com/aiidateam/aiida-core) ⭐ 583 | 🐛 686 | 🌐 Python | 📅 2026-09-09 - workflow manager with a strong focus on provenance, performance and extensibility.
* [HyperQueue](https://github.com/It4innovations/hyperqueue) ⭐ 559 | 🐛 57 | 🌐 Rust | 📅 2026-09-09 - HPC-focused task scheduler that automatically assigns tasks to Slurm/PBS allocations and submits them for the user.
* [PipeFunc](https://github.com/pipefunc/pipefunc) ⭐ 480 | 🐛 75 | 🌐 Python | 📅 2026-09-09 - Lightweight function pipeline (DAG) creation in pure Python for scientific workflows.
...
* [Mistral](https://github.com/openstack/mistral) ⭐ 309 | 🐛 0 | 🌐 Python | 📅 2026-09-08 - Python based workflow engine by the Open Stack project.
...
* [Bpipe](https://github.com/ssadedin/bpipe/) ⭐ 241 | 🐛 158 | 🌐 Groovy | 📅 2026-09-05 - Tool for running and managing bioinformatics pipelines.
...
* [pytask](https://github.com/pytask-dev/pytask) ⭐ 146 | 🐛 18 | 🌐 Python | 📅 2026-09-08 - A workflow management system that facilitates reproducible data analyses.
* [Pydra](https://github.com/nipype/pydra) ⭐ 144 | 🐛 91 | 🌐 Python | 📅 2026-09-09 - Lightweight, DAG-based Python dataflow engine for reproducible and scalable scientific pipelines.
...
* [Briefly](https://github.com/bloomreach/briefly) ⭐ 108 | 🐛 4 | 🌐 Python | 📅 2018-09-10 - Python Meta-programming Library for Job Flow Control.
...
* [Porcupine](https://github.com/tweag/porcupine) ⭐ 89 | 🐛 25 | 🌐 Haskell | 📅 2022-04-06 - Haskell workflow tool to express and compose tasks (optionally cached) whose datasources and sinks are known ahead of time and rebindable, and which can expose arbitrary sets of parameters to the outside world.
...
* [Renart](https://github.com/renart-data/renart) ⭐ 73 | 🐛 42 | 🌐 Go | 📅 2026-09-09 - Local-first IDE for authoring and running SQL and Python data pipelines stored in Git.
...
* [ecFlow](https://github.com/ecmwf/ecflow) ⭐ 65 | 🐛 14 | 🌐 C++ | 📅 2026-09-09 - Workflow manager.
* [StreamFlow](https://github.com/alpha-unito/streamflow) ⭐ 65 | 🐛 34 | 🌐 Python | 📅 2026-09-09 - Container native workflow management system focused on hybrid workflows.
...
* [Windmill](https://github.com/windmill-labs/windmill) ⭐ 17,828 | 🐛 851 | 🌐 Rust | 📅 2026-09-09 - Developer platform and workflow engine to turn scripts into internal tools.
* [Flyte](https://github.com/lyft/flyte) ⭐ 7,434 | 🐛 187 | 🌐 Go | 📅 2026-09-09 - Container-native, type-safe workflow and pipelines platform for large scale processing and ML.
* [Orchest](https://github.com/orchest/orchest) ⚠️ Archived - An IDE for Data Science.
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,728 | 🐛 125 | 🌐 MDX | 📅 2026-09-09 - A platform for machine learning experimentation workflow.
...
* [Reana](https://github.com/reanahub/reana) ⭐ 153 | 🐛 109 | 🌐 Python | 📅 2026-08-20 - Platform for reusable research data analyses developed by CERN.
* [omega|ml DataOps Platform](https://github.com/omegaml/omegaml) ⭐ 107 | 🐛 95 | 🌐 Python | 📅 2026-09-09 - Data & model pipeline deployment for humans - integrated, scalable, extensible.
...
* [Sushi](https://github.com/uzh/sushi) ⭐ 29 | 🐛 0 | 🌐 Ruby | 📅 2026-09-07 - Supporting User for SHell script Integration.
...
* [Workflow Description Language](https://github.com/openwdl/wdl) ⭐ 857 | 🐛 67 | 📅 2026-09-08
...
* [lakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,519 | 🐛 441 | 🌐 Go | 📅 2026-08-19 - Repeatable, atomic and versioned data lake on top of object storage.
* [Nessie](https://github.com/projectnessie/nessie) ⭐ 1,505 | 🐛 168 | 🌐 Java | 📅 2026-09-09 - Provides Git-like capability & version control for Iceberg Tables, Delta Lake Tables & SQL Views.
...
* [Polynote](https://github.com/polynote/polynote) ⭐ 4,597 | 🐛 231 | 🌐 Jupyter Notebook | 📅 2026-01-27 - A better notebook for Scala (and more). Built by Netflix.
...
* [Pathway](https://github.com/pathwaycom/pathway/) ⭐ 62,314 | 🐛 35 | 🌐 Python | 📅 2026-09-09 - Performant open-source Python ETL framework with Rust runtime, supporting 300+ data sources.
* [Cadence](https://github.com/uber/cadence) ⭐ 9,434 | 🐛 198 | 🌐 Go | 📅 2026-09-09 Distributed, scalable, durable, and highly available orchestration engine developed by Uber.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,702 | 🐛 63 | 🌐 Go | 📅 2026-09-09 - Data pipeline framework supporting SQL and Python in the same DAG. Built-in data quality assertions, cross-database lineage, and incremental processing. Targets data warehouses (BigQuery, Snowflake, Postgres, etc.).
* [Dataform](https://github.com/dataform-co/dataform) ⭐ 996 | 🐛 112 | 🌐 TypeScript | 📅 2026-09-09 - Dataform is a framework for managing SQL based operations in your data warehouse.
...
* [Argo](https://github.com/argoproj/argo) ⭐ 16,966 | 🐛 1,279 | 🌐 Go | 📅 2026-09-09 - Get stuff done with container-native workflows for Kubernetes.
* [CDS](https://github.com/ovh/cds) ⭐ 4,839 | 🐛 164 | 🌐 Go | 📅 2026-09-09 - A pipeline based Continuous Delivery Service written in Golang.

## Build automation tools

* [Just](https://github.com/casey/just) ⭐ 35,703 | 🐛 171 | 🌐 Rust | 📅 2026-09-01 - Command and recipe runner similar to Make, built in Rust.
...
* [APE](https://github.com/sanctuuary/APE) ⭐ 23 | 🐛 13 | 🌐 Java | 📅 2026-05-06 - A tool for the automated exploration of possible computational workflows based on semantic annotations.
...
* [Awesome workflow engines](https://github.com/meirwah/awesome-workflow-engines) ⭐ 7,926 | 🐛 71 | 📅 2026-04-06 - Curated list of awesome open source workflow engines.
* [Awesome ETL](https://github.com/pawl/awesome-etl) ⭐ 3,590 | 🐛 13 | 📅 2026-05-01 - Curated list of notable ETL (extract, transform, load) frameworks, libraries and software.
* [Awesome streaming](https://github.com/manuzhang/awesome-streaming) ⭐ 3,015 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-08 - Curated list of awesome streaming frameworks, applications.
