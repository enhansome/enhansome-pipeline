...
A curated list of awesome pipeline toolkits inspired by [Awesome Sysadmin](https://github.com/kahun/awesome-sysadmin) ⭐ 24,338 | 🐛 274 | 📅 2024-03-26

## Pipeline frameworks & libraries

* [Airflow](https://github.com/airbnb/airflow) ⭐ 46,954 | 🐛 2,098 | 🌐 Python | 📅 2026-09-23 - Python-based workflow system created by AirBnb.
* [Ray](https://github.com/ray-project/ray) ⭐ 43,910 | 🐛 3,616 | 🌐 Python | 📅 2026-09-23 - Flexible, high-performance distributed Python execution framework.
* [Kestra](https://github.com/kestra-io/kestra) ⭐ 28,310 | 🐛 685 | 🌐 Java | 📅 2026-09-23 - Open source data orchestration and scheduling platform with declarative syntax.
...
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 16,197 | 🐛 2,569 | 🌐 Python | 📅 2026-09-23 - Python-based API for defining DAGs that interfaces with popular workflow managers for building data applications.
* [Dask](https://github.com/dask/dask) ⭐ 13,924 | 🐛 1,340 | 🌐 Python | 📅 2026-08-24 - Dask is a flexible parallel computing library for analytics.
* [Cocoindex](https://github.com/cocoindex-io/cocoindex) ⭐ 11,591 | 🐛 85 | 🌐 Rust | 📅 2026-09-22 - ETL framework to build fresh index.
* [Kedro](https://github.com/quantumblacklabs/kedro) ⭐ 11,007 | 🐛 134 | 🌐 Python | 📅 2026-09-22 - Workflow development tool that helps you build data pipelines.
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,598 | 🐛 175 | 🌐 Jupyter Notebook | 📅 2026-09-23 - A python micro-framework for describing dataflows; runs anywhere python runs.
...
* [Spiff](https://github.com/knipknap/SpiffWorkflow) ⭐ 1,919 | 🐛 8 | 🌐 Python | 📅 2026-09-02 - Based on the Workflow Patterns initiative and implemented in Python.
...
* [Covalent](https://github.com/AgnostiqHQ/covalent) ⭐ 868 | 🐛 104 | 🌐 Python | 📅 2026-08-31 - Workflow orchestration toolkit for high-performance and quantum computing research and development.
...
* [AiiDA](https://github.com/aiidateam/aiida-core) ⭐ 590 | 🐛 706 | 🌐 Python | 📅 2026-09-23 - workflow manager with a strong focus on provenance, performance and extensibility.
* [HyperQueue](https://github.com/It4innovations/hyperqueue) ⭐ 564 | 🐛 55 | 🌐 Rust | 📅 2026-09-23 - HPC-focused task scheduler that automatically assigns tasks to Slurm/PBS allocations and submits them for the user.
...
* [Renart](https://github.com/renart-data/renart) ⭐ 75 | 🐛 20 | 🌐 Go | 📅 2026-09-22 - Local-first IDE for authoring and running SQL and Python data pipelines stored in Git.
...
* [ecFlow](https://github.com/ecmwf/ecflow) ⭐ 65 | 🐛 10 | 🌐 C++ | 📅 2026-09-23 - Workflow manager.
...
* [Windmill](https://github.com/windmill-labs/windmill) ⭐ 18,018 | 🐛 873 | 🌐 Rust | 📅 2026-09-23 - Developer platform and workflow engine to turn scripts into internal tools.
* [Flyte](https://github.com/lyft/flyte) ⭐ 7,557 | 🐛 182 | 🌐 Go | 📅 2026-09-23 - Container-native, type-safe workflow and pipelines platform for large scale processing and ML.
* [Orchest](https://github.com/orchest/orchest) ⚠️ Archived - An IDE for Data Science.
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,735 | 🐛 125 | 🌐 MDX | 📅 2026-09-23 - A platform for machine learning experimentation workflow.
...
* [Sushi](https://github.com/uzh/sushi) ⭐ 29 | 🐛 0 | 🌐 Ruby | 📅 2026-09-22 - Supporting User for SHell script Integration.
...
* [lakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,541 | 🐛 446 | 🌐 Go | 📅 2026-09-23 - Repeatable, atomic and versioned data lake on top of object storage.
* [Nessie](https://github.com/projectnessie/nessie) ⭐ 1,514 | 🐛 166 | 🌐 Java | 📅 2026-09-23 - Provides Git-like capability & version control for Iceberg Tables, Delta Lake Tables & SQL Views.
...
* [Cadence](https://github.com/uber/cadence) ⭐ 9,448 | 🐛 193 | 🌐 Go | 📅 2026-09-23 Distributed, scalable, durable, and highly available orchestration engine developed by Uber.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,725 | 🐛 63 | 🌐 Go | 📅 2026-09-23 - Data pipeline framework supporting SQL and Python in the same DAG. Built-in data quality assertions, cross-database lineage, and incremental processing. Targets data warehouses (BigQuery, Snowflake, Postgres, etc.).
* [Dataform](https://github.com/dataform-co/dataform) ⭐ 995 | 🐛 119 | 🌐 TypeScript | 📅 2026-09-23 - Dataform is a framework for managing SQL based operations in your data warehouse.
...
- [Omniload](https://github.com/panodata/omniload) ⭐ 5 | 🐛 42 | 🌐 Python | 📅 2026-09-23 - Polyglot data loader based on dlt for ETL, warehousing and more. Copy data between any source and any destination. Supports 140+ source/destination adapters. Fast transformations based on Polars expressions.
...
* [Argo](https://github.com/argoproj/argo) ⭐ 17,000 | 🐛 1,291 | 🌐 Go | 📅 2026-09-23 - Get stuff done with container-native workflows for Kubernetes.
* [CDS](https://github.com/ovh/cds) ⭐ 4,844 | 🐛 161 | 🌐 Go | 📅 2026-09-23 - A pipeline based Continuous Delivery Service written in Golang.

## Build automation tools

* [Just](https://github.com/casey/just) ⭐ 35,977 | 🐛 172 | 🌐 Rust | 📅 2026-09-22 - Command and recipe runner similar to Make, built in Rust.
...
* [Awesome ETL](https://github.com/pawl/awesome-etl) ⭐ 3,592 | 🐛 16 | 📅 2026-05-01 - Curated list of notable ETL (extract, transform, load) frameworks, libraries and software.
* [Awesome streaming](https://github.com/manuzhang/awesome-streaming) ⭐ 3,018 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-22 - Curated list of awesome streaming frameworks, applications.
