...
A curated list of awesome pipeline toolkits inspired by [Awesome Sysadmin](https://github.com/kahun/awesome-sysadmin) ⭐ 24,346 | 🐛 271 | 📅 2024-03-26

## Pipeline frameworks & libraries

* [Airflow](https://github.com/airbnb/airflow) ⭐ 46,684 | 🐛 2,049 | 🌐 Python | 📅 2026-09-01 - Python-based workflow system created by AirBnb.
* [Ray](https://github.com/ray-project/ray) ⭐ 43,677 | 🐛 3,551 | 🌐 Python | 📅 2026-09-01 - Flexible, high-performance distributed Python execution framework.
* [Kestra](https://github.com/kestra-io/kestra) ⭐ 27,967 | 🐛 642 | 🌐 Java | 📅 2026-09-01 - Open source data orchestration and scheduling platform with declarative syntax.
...
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 16,080 | 🐛 2,582 | 🌐 Python | 📅 2026-09-01 - Python-based API for defining DAGs that interfaces with popular workflow managers for building data applications.
* [Dask](https://github.com/dask/dask) ⭐ 13,910 | 🐛 1,322 | 🌐 Python | 📅 2026-08-24 - Dask is a flexible parallel computing library for analytics.
* [Cocoindex](https://github.com/cocoindex-io/cocoindex) ⭐ 11,448 | 🐛 77 | 🌐 Rust | 📅 2026-08-31 - ETL framework to build fresh index.
* [Kedro](https://github.com/quantumblacklabs/kedro) ⭐ 10,989 | 🐛 142 | 🌐 Python | 📅 2026-09-01 - Workflow development tool that helps you build data pipelines.
...
* [Burr](https://github.com/dagworks-inc/burr) ⭐ 2,535 | 🐛 104 | 🌐 Python | 📅 2026-09-01 - Python based lightweight graph (i.e. can do loops and conditional branching, and not just DAGs) orchestrator.
...
* [Spiff](https://github.com/knipknap/SpiffWorkflow) ⭐ 1,914 | 🐛 8 | 🌐 Python | 📅 2026-08-31 - Based on the Workflow Patterns initiative and implemented in Python.
...
* [Cromwell](https://github.com/broadinstitute/cromwell) ⭐ 1,080 | 🐛 814 | 🌐 Scala | 📅 2026-08-31 - Workflow Management System geared towards scientific workflows from the Broad Institute.
...
* [Toil](https://github.com/BD2KGenomics/toil) ⭐ 936 | 🐛 407 | 🌐 Python | 📅 2026-08-31 - Distributed pipeline workflow manager (mostly for genomics).
* [Hera](https://github.com/argoproj-labs/hera) ⭐ 935 | 🐛 27 | 🌐 Python | 📅 2026-08-18 - Hera is an Argo Python SDK. Hera aims to make construction and submission of various Argo Project resources easy and accessible to everyone! Hera abstracts away low-level setup details while still maintaining a consistent vocabulary with Argo.
* [Covalent](https://github.com/AgnostiqHQ/covalent) ⭐ 869 | 🐛 103 | 🌐 Python | 📅 2026-08-31 - Workflow orchestration toolkit for high-performance and quantum computing research and development.
...
* [Redun](https://github.com/insitro/redun) ⭐ 599 | 🐛 34 | 🌐 Python | 📅 2026-07-17 - Yet another redundant workflow engine.
* [AiiDA](https://github.com/aiidateam/aiida-core) ⭐ 581 | 🐛 678 | 🌐 Python | 📅 2026-09-01 - workflow manager with a strong focus on provenance, performance and extensibility.
* [HyperQueue](https://github.com/It4innovations/hyperqueue) ⭐ 557 | 🐛 55 | 🌐 Rust | 📅 2026-09-01 - HPC-focused task scheduler that automatically assigns tasks to Slurm/PBS allocations and submits them for the user.
* [PipeFunc](https://github.com/pipefunc/pipefunc) ⭐ 477 | 🐛 75 | 🌐 Python | 📅 2026-09-01 - Lightweight function pipeline (DAG) creation in pure Python for scientific workflows.
...
* [pytask](https://github.com/pytask-dev/pytask) ⭐ 146 | 🐛 18 | 🌐 Python | 📅 2026-08-31 - A workflow management system that facilitates reproducible data analyses.
...
* [pyppl](https://github.com/pwwang/pyppl) ⭐ 111 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - A python lightweight pipeline framework.
...
* [StreamFlow](https://github.com/alpha-unito/streamflow) ⭐ 65 | 🐛 34 | 🌐 Python | 📅 2026-09-01 - Container native workflow management system focused on hybrid workflows.
* [ecFlow](https://github.com/ecmwf/ecflow) ⭐ 64 | 🐛 17 | 🌐 C++ | 📅 2026-09-01 - Workflow manager.
...
* [Windmill](https://github.com/windmill-labs/windmill) ⭐ 17,753 | 🐛 844 | 🌐 Rust | 📅 2026-09-01 - Developer platform and workflow engine to turn scripts into internal tools.
* [Flyte](https://github.com/lyft/flyte) ⭐ 7,362 | 🐛 171 | 🌐 Go | 📅 2026-09-01 - Container-native, type-safe workflow and pipelines platform for large scale processing and ML.
* [Orchest](https://github.com/orchest/orchest) ⚠️ Archived - An IDE for Data Science.
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,727 | 🐛 126 | 🌐 MDX | 📅 2026-08-31 - A platform for machine learning experimentation workflow.
...
* [Reana](https://github.com/reanahub/reana) ⭐ 152 | 🐛 104 | 🌐 Python | 📅 2026-08-20 - Platform for reusable research data analyses developed by CERN.
* [omega|ml DataOps Platform](https://github.com/omegaml/omegaml) ⭐ 107 | 🐛 95 | 🌐 Python | 📅 2026-09-01 - Data & model pipeline deployment for humans - integrated, scalable, extensible.
...
* [Sushi](https://github.com/uzh/sushi) ⭐ 29 | 🐛 0 | 🌐 Ruby | 📅 2026-09-01 - Supporting User for SHell script Integration.
...
* [lakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,506 | 🐛 440 | 🌐 Go | 📅 2026-08-19 - Repeatable, atomic and versioned data lake on top of object storage.
* [Nessie](https://github.com/projectnessie/nessie) ⭐ 1,498 | 🐛 169 | 🌐 Java | 📅 2026-09-01 - Provides Git-like capability & version control for Iceberg Tables, Delta Lake Tables & SQL Views.
...
* [Pathway](https://github.com/pathwaycom/pathway/) ⭐ 62,348 | 🐛 35 | 🌐 Python | 📅 2026-09-01 - Performant open-source Python ETL framework with Rust runtime, supporting 300+ data sources.
* [Cadence](https://github.com/uber/cadence) ⭐ 9,428 | 🐛 203 | 🌐 Go | 📅 2026-09-01 Distributed, scalable, durable, and highly available orchestration engine developed by Uber.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,682 | 🐛 56 | 🌐 Go | 📅 2026-09-01 - Data pipeline framework supporting SQL and Python in the same DAG. Built-in data quality assertions, cross-database lineage, and incremental processing. Targets data warehouses (BigQuery, Snowflake, Postgres, etc.).
* [Dataform](https://github.com/dataform-co/dataform) ⭐ 995 | 🐛 110 | 🌐 TypeScript | 📅 2026-09-01 - Dataform is a framework for managing SQL based operations in your data warehouse.
...
* [Argo](https://github.com/argoproj/argo) ⭐ 16,948 | 🐛 1,257 | 🌐 Go | 📅 2026-09-01 - Get stuff done with container-native workflows for Kubernetes.
* [CDS](https://github.com/ovh/cds) ⭐ 4,837 | 🐛 159 | 🌐 Go | 📅 2026-09-01 - A pipeline based Continuous Delivery Service written in Golang.

## Build automation tools

* [Just](https://github.com/casey/just) ⭐ 35,573 | 🐛 173 | 🌐 Rust | 📅 2026-08-20 - Command and recipe runner similar to Make, built in Rust.
...
* [Awesome workflow engines](https://github.com/meirwah/awesome-workflow-engines) ⭐ 7,919 | 🐛 71 | 📅 2026-04-06 - Curated list of awesome open source workflow engines.
* [Awesome ETL](https://github.com/pawl/awesome-etl) ⭐ 3,589 | 🐛 12 | 📅 2026-05-01 - Curated list of notable ETL (extract, transform, load) frameworks, libraries and software.
* [Awesome streaming](https://github.com/manuzhang/awesome-streaming) ⭐ 3,010 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-31 - Curated list of awesome streaming frameworks, applications.
