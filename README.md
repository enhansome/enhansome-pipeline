...
A curated list of awesome pipeline toolkits inspired by [Awesome Sysadmin](https://github.com/kahun/awesome-sysadmin) ⭐ 24,341 | 🐛 272 | 📅 2024-03-26

## Pipeline frameworks & libraries

* [Airflow](https://github.com/airbnb/airflow) ⭐ 46,855 | 🐛 2,137 | 🌐 Python | 📅 2026-09-14 - Python-based workflow system created by AirBnb.
* [Ray](https://github.com/ray-project/ray) ⭐ 43,799 | 🐛 3,609 | 🌐 Python | 📅 2026-09-14 - Flexible, high-performance distributed Python execution framework.
* [Kestra](https://github.com/kestra-io/kestra) ⭐ 28,111 | 🐛 689 | 🌐 Java | 📅 2026-09-14 - Open source data orchestration and scheduling platform with declarative syntax.
...
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 16,150 | 🐛 2,585 | 🌐 Python | 📅 2026-09-14 - Python-based API for defining DAGs that interfaces with popular workflow managers for building data applications.
* [Dask](https://github.com/dask/dask) ⭐ 13,916 | 🐛 1,332 | 🌐 Python | 📅 2026-08-24 - Dask is a flexible parallel computing library for analytics.
* [Cocoindex](https://github.com/cocoindex-io/cocoindex) ⭐ 11,548 | 🐛 84 | 🌐 Rust | 📅 2026-09-14 - ETL framework to build fresh index.
* [Kedro](https://github.com/quantumblacklabs/kedro) ⭐ 10,996 | 🐛 137 | 🌐 Python | 📅 2026-09-11 - Workflow development tool that helps you build data pipelines.
...
* [Burr](https://github.com/dagworks-inc/burr) ⭐ 2,548 | 🐛 99 | 🌐 Python | 📅 2026-09-12 - Python based lightweight graph (i.e. can do loops and conditional branching, and not just DAGs) orchestrator.
...
* [Cromwell](https://github.com/broadinstitute/cromwell) ⭐ 1,082 | 🐛 814 | 🌐 Scala | 📅 2026-09-14 - Workflow Management System geared towards scientific workflows from the Broad Institute.
...
* [AiiDA](https://github.com/aiidateam/aiida-core) ⭐ 585 | 🐛 689 | 🌐 Python | 📅 2026-09-14 - workflow manager with a strong focus on provenance, performance and extensibility.
* [HyperQueue](https://github.com/It4innovations/hyperqueue) ⭐ 560 | 🐛 57 | 🌐 Rust | 📅 2026-09-14 - HPC-focused task scheduler that automatically assigns tasks to Slurm/PBS allocations and submits them for the user.
* [PipeFunc](https://github.com/pipefunc/pipefunc) ⭐ 481 | 🐛 75 | 🌐 Python | 📅 2026-09-14 - Lightweight function pipeline (DAG) creation in pure Python for scientific workflows.
...
* [pytask](https://github.com/pytask-dev/pytask) ⭐ 146 | 🐛 18 | 🌐 Python | 📅 2026-09-14 - A workflow management system that facilitates reproducible data analyses.
...
* [Renart](https://github.com/renart-data/renart) ⭐ 73 | 🐛 44 | 🌐 Go | 📅 2026-09-14 - Local-first IDE for authoring and running SQL and Python data pipelines stored in Git.
...
* [ecFlow](https://github.com/ecmwf/ecflow) ⭐ 65 | 🐛 12 | 🌐 C++ | 📅 2026-09-14 - Workflow manager.
* [StreamFlow](https://github.com/alpha-unito/streamflow) ⭐ 65 | 🐛 32 | 🌐 Python | 📅 2026-09-14 - Container native workflow management system focused on hybrid workflows.
...
* [Dotflow](https://github.com/dotflow-io/dotflow) ⭐ 9 | 🐛 37 | 🌐 Python | 📅 2026-09-14 - Python library for creating pipelines and workflows easily.
...
* [Windmill](https://github.com/windmill-labs/windmill) ⭐ 17,923 | 🐛 849 | 🌐 Rust | 📅 2026-09-14 - Developer platform and workflow engine to turn scripts into internal tools.
* [Flyte](https://github.com/lyft/flyte) ⭐ 7,488 | 🐛 178 | 🌐 Go | 📅 2026-09-14 - Container-native, type-safe workflow and pipelines platform for large scale processing and ML.
* [Orchest](https://github.com/orchest/orchest) ⚠️ Archived - An IDE for Data Science.
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,730 | 🐛 125 | 🌐 MDX | 📅 2026-09-14 - A platform for machine learning experimentation workflow.
...
* [Sushi](https://github.com/uzh/sushi) ⭐ 29 | 🐛 0 | 🌐 Ruby | 📅 2026-09-14 - Supporting User for SHell script Integration.
...
* [lakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,525 | 🐛 441 | 🌐 Go | 📅 2026-08-19 - Repeatable, atomic and versioned data lake on top of object storage.
* [Nessie](https://github.com/projectnessie/nessie) ⭐ 1,510 | 🐛 163 | 🌐 Java | 📅 2026-09-14 - Provides Git-like capability & version control for Iceberg Tables, Delta Lake Tables & SQL Views.
...
* [Cadence](https://github.com/uber/cadence) ⭐ 9,438 | 🐛 205 | 🌐 Go | 📅 2026-09-11 Distributed, scalable, durable, and highly available orchestration engine developed by Uber.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,705 | 🐛 58 | 🌐 Go | 📅 2026-09-14 - Data pipeline framework supporting SQL and Python in the same DAG. Built-in data quality assertions, cross-database lineage, and incremental processing. Targets data warehouses (BigQuery, Snowflake, Postgres, etc.).
* [Dataform](https://github.com/dataform-co/dataform) ⭐ 996 | 🐛 115 | 🌐 TypeScript | 📅 2026-09-14 - Dataform is a framework for managing SQL based operations in your data warehouse.
...
* [Argo](https://github.com/argoproj/argo) ⭐ 16,977 | 🐛 1,282 | 🌐 Go | 📅 2026-09-14 - Get stuff done with container-native workflows for Kubernetes.
* [CDS](https://github.com/ovh/cds) ⭐ 4,841 | 🐛 162 | 🌐 Go | 📅 2026-09-14 - A pipeline based Continuous Delivery Service written in Golang.

## Build automation tools

* [Just](https://github.com/casey/just) ⭐ 35,794 | 🐛 171 | 🌐 Rust | 📅 2026-09-01 - Command and recipe runner similar to Make, built in Rust.
...
* [Awesome workflow engines](https://github.com/meirwah/awesome-workflow-engines) ⭐ 7,928 | 🐛 72 | 📅 2026-04-06 - Curated list of awesome open source workflow engines.
* [Awesome ETL](https://github.com/pawl/awesome-etl) ⭐ 3,593 | 🐛 13 | 📅 2026-05-01 - Curated list of notable ETL (extract, transform, load) frameworks, libraries and software.
* [Awesome streaming](https://github.com/manuzhang/awesome-streaming) ⭐ 3,017 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-13 - Curated list of awesome streaming frameworks, applications.
